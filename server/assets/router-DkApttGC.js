...
const cpaLogo$1 = "/shivangitankshali/assets/cpa-logo-GushWGLn.jpeg";
const nav = [
  { to: "/", label: "Home" },
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 w-full border-b border-border/60 bg-background/85 backdrop-blur-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-6xl items-center justify-between px-5 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5", onClick: () => setOpen(false), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: cpaLogo$1, alt: "Certified Public Accountant logo", className: "h-10 w-10 rounded-full object-contain shadow-soft" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex flex-col leading-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-lg text-foreground", children: "Shivangi Tankshali" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-[0.18em] text-muted-foreground", children: "CPA · USA & CA" })
        ] })
      ] }),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border bg-background md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "mx-auto flex max-w-6xl flex-col px-5 py-3", children: [
      nav.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: n.to,
...
const cpaLogo = "/shivangitankshali/assets/cpa-logo-GushWGLn.jpeg";
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border bg-secondary/40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: cpaLogo, alt: "CPA Logo", className: "h-9 w-9 rounded-md object-cover" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-lg", children: "Shivangi Tankshali, CPA" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-xs text-sm text-muted-foreground", children: "Licensed US CPA helping businesses and individuals navigate US taxes with clarity and confidence." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-base text-foreground", children: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-2 text-sm text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "hover:text-foreground", children: "Book a consultation" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-base text-foreground", children: "Get in touch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mt-4 space-y-3 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 15, className: "text-gold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:cashivangitankshali@gmail.com", className: "hover:text-foreground", children: "cashivangitankshali@gmail.com" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 15, className: "text-gold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+919925193737", className: "hover:text-foreground", children: "+91 99251 93737" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-3 pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.linkedin.com/in/shivangi-tankshali-1534171a3/", target: "_blank", rel: "noopener noreferrer", "aria-label": "LinkedIn", className: "rounded-md border border-border p-2 hover:text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { size: 15 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.instagram.com/shivangi_tankshali/", target: "_blank", rel: "noopener noreferrer", "aria-label": "Instagram", className: "rounded-md border border-border p-2 hover:text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { size: 15 }) })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-5 py-5 text-xs text-muted-foreground", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Shivangi Tankshali, CPA. All rights reserved."
    ] }) })
  ] });
}
const appCss = "/shivangitankshali/assets/styles-OkIDONOc.css";
...
const Route$5 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Shivangi Tankshali, CPA — US Tax & Advisory for Small Businesses" },
      { name: "description", content: "Licensed US CPA helping small businesses, founders, and individuals with US tax filing, LLC & S-Corp setup, bookkeeping, payroll, and ongoing tax strategy." },
      { name: "author", content: "Shivangi Tankshali, CPA" },
      { property: "og:title", content: "Shivangi Tankshali, CPA" },
      { property: "og:description", content: "US tax filing, LLC/S-Corp strategy, bookkeeping, payroll and advisory." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600&family=Inter:wght@400;500;600;700&display=swap" }
    ]
  }),
...
const $$splitComponentImporter$3 = () => import("./services-BtDR8OGn.js");
const Route$3 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tax advisory, personal tax planning, bookkeeping, payroll, tax preparation, financial accounting, financial advisory, tax law, financial and business consulting."
    }, {
      property: "og:title",
      content: "CPA Services — Shivangi Tankshali"
    }, {
      property: "og:description",
      content: "Full-service US tax and advisory for small businesses, founders, and individuals."
    }, {
      property: "og:url",
      content: "/services"
    }],
...
const $$splitComponentImporter$2 = () => import("./contact-R3VSZjvB.js");
const Route$2 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Book a consultation with Shivangi Tankshali, licensed US CPA. Email cashivangitankshali@gmail.com or call +91 99251 93737."
    }, {
      property: "og:title",
      content: "Contact Shivangi Tankshali, CPA"
    }, {
      property: "og:description",
      content: "Book a quick consultation about your US tax situation."
    }, {
      property: "og:url",
      content: "/contact"
    }],
...
const $$splitComponentImporter$1 = () => import("./about-18vZSL2h.js");
const Route$1 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "US licensed CPA and Indian Chartered Accountant with 10+ years experience in accounting, taxation, and auditing."
    }, {
      property: "og:title",
      content: "About — Shivangi Tankshali, CPA & CA"
    }, {
      property: "og:description",
      content: "Professional experience in accounting, taxation, auditing, and financial advisory services for US compliance."
    }, {
      property: "og:url",
      content: "/about"
    }],
...
const $$splitComponentImporter = () => import("./index-DcgPpHMB.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "US licensed CPA and Indian Chartered Accountant with 10+ years experience. Helping businesses navigate US financial and compliance requirements."
    }, {
      property: "og:title",
      content: "Shivangi Tankshali, CPA & CA — US Tax Filing & Advisory"
    }, {
      property: "og:description",
      content: "US tax filing, LLC/S-Corp strategy, bookkeeping, payroll, and ongoing advisory."
    }],
    links: [{
      rel: "canonical",
      href: "/"
