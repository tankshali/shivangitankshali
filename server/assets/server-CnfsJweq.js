...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-o0OpKA5P.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DkApttGC.js").then((n2) => n2.r),
    import("./start-Dws9E6KH.js"),
...
var ROUTER_BASEPATH = "shivangitankshali";
var SERVER_FN_BASE = "/shivangitankshali/_serverFn/";
