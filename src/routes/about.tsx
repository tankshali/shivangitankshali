...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "US licensed CPA and Indian Chartered Accountant with 10+ years experience in accounting, taxation, and auditing." },
      { property: "og:title", content: "About — Shivangi Tankshali, CPA & CA" },
      { property: "og:description", content: "Professional experience in accounting, taxation, auditing, and financial advisory services for US compliance." },
